const slides = [
    ...
    '<div class="new-arrivals__slide"><img src="img/new_arrival_leash.jpg" alt="SERA Woven Leash"><h3><a href="./partials/new_arrival_leash.html" class="new-arrivals__name">SERA Woven Leash</a></h3><h4>$2.00</h4><div class="wrapper"><a href="#" class="add-btn"><span class="add-btn__text">Add to Cart</span></a></div></div>',
    '<div class="new-arrivals__slide"><img src="img/new_arrival_bowl.jpg" alt="OPTY Plastic Bowl"><h3><a href="./partials/new_arrival_bowl.html" class="new-arrivals__name">OPTY Plastic Bowl</a></h3><h4>$3.00</h4><div class="wrapper"><a href="#" class="add-btn"><span class="add-btn__text">Add to Cart</span></a></div></div>',
    '<div class="new-arrivals__slide"><img src="img/new_arrival_butterfly.jpg" alt="EGO Butterfly Toy"><h3><a href="./partials/new_arrival_butterfly.html" class="new-arrivals__name">EGO Butterfly Toy</a></h3><h4>$2.00</h4><div class="wrapper"><a href="#" class="add-btn"><span class="add-btn__text">Add to Cart</span></a></div></div>'
];
